    ...
    <nav class="navbar navbar-expand-sm navbar-light d-flex justify-content-end "> <!--la barre de navigation-->
            
        <ul class="navbar-nav"> <!-- items de la barre de navigation-->
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" type="submit" href="index.php?page=mentions"><strong>Mentions legales</strong></a>
            </li>
            <li class="nav-item">
